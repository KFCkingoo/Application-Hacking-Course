...
Tehtävässä c) käytiin hieman läpi binääristä hyppyehtoja JNZ ja JZ. Ohjelman if-ehdoista löytyi JZ hyppyehto, mikä tekee hypyn kun tulos on 0. Katsottiin sen if-ehtoa lisää.
...
https://www.codestudy.net/blog/difference-between-je-jne-and-jz-jnz/#jne-jump-if-not-equal
